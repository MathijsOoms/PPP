...
const company = {
  ...
  recentProducts: ['Laptop', 'Fridge', 'Earpad', 'Monitor'],
  popularProducts: ['Keyboard', 'Dishwasher', 'Mouse'],
  numberOfEmployees: {
    development: {
      active: 50,
      onVacation: 4,
  ...
  buyProducts: function ({ price = '50', quantity = '1', recentIndex, popularIndex }) {
...
const description = 'Power down you drive, power down your passion!';
...
const capitalize = function (name) {
  ...
  for (const word of words) {
    wordsCapitalize.push(words[0].toUpperCase()+word.slice(1));
  }
...
// const [firstLetter, secondLetter, ...restLetters] = ['a', 'b', 'c', 'd', 'e', 'f']
// console.log(firstLetter, secondLetter, restLetters);

// const [product1, product2, ...restProducts] = [...company.recentProducts, ...company.popularProducts]
...
// const { development: {active: activeEmployees, onVacation: onVacationEmployees} } = numberOfEmployees;
